...
urlpatterns = [
    ...
    path("linkedin-employee-review/<int:campaign_id>/", views.LinkedinEmployeeReviewView.as_view(), name="linkedin_employee_review"),
    ...
    path("export/full-export/<int:campaign_id>/", views.export_full_excel, name="export_full_excel"),
