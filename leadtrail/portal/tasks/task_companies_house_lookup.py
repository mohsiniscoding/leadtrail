"""
Companies House Lookup Task
==========================

This task performs Companies House lookup operations by fetching company numbers
from the database, processing them through the Companies House API, and storing
...
def _map_company_data_to_model(company_data: CompanyData, company_number_obj: CompanyNumber) -> CompanyHouseData:
    ...
    """
    # Handle error message - use notes field for errors
    error_message = None
...
def run():
    ...
    try:
        ...
        error_msg = f"Companies House lookup task failed: {str(e)}"
