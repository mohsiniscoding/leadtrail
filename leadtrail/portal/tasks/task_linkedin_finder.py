...
This task performs LinkedIn profile finding operations on companies in campaigns
where LinkedIn lookup is enabled. It uses the LinkedInFinder module to search
for company and employee profiles via SERP API, utilizing approved domains
for enhanced matching accuracy.
"""
import logging
...
def run():
    ...
    """
    logger.info("[SINGLETON] LinkedIn finder task started - Lock expiry: 600s")
    ...
    try:
        ...
        error_msg = f"LinkedIn finder task failed: {str(e)}"
